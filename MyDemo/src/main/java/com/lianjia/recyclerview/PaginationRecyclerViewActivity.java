...
public class PaginationRecyclerViewActivity extends Activity implements
    ...
    private void initHeader() {
        ...
        ljPaginationWrappedRecyclerView.addHeaderView(tv1);
        ...
        ljPaginationWrappedRecyclerView.addHeaderView(tv2);
        ...
        ljPaginationWrappedRecyclerView.addHeaderView(tv3);

        TextView f1 = new TextView(this);
        f1.setBackgroundColor(Color.BLUE);
        f1.setTextColor(Color.WHITE);
        f1.setText("footer1");
        ljPaginationWrappedRecyclerView.addFooterView(f1);
        ...
        ljPaginationWrappedRecyclerView.addFooterView(f2);
    }
    ...
    @Override public void onPullRefresh() {
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                ljPaginationWrappedRecyclerView.setEnabled(true);
                ljPaginationWrappedRecyclerView.setRefreshing(false);
    ...
    @Override public void onLoadMore() {
        ljPaginationWrappedRecyclerView.postDelayed(new Runnable() {
            @Override
            public void run() {
